  ...
  return (
    <div className="note-view">
      <div className="note-view-links">
        <div className="note-view-link" onClick={props.editMethod}>
          edit
        </div>
        <div onClick={props.deleteMethod} className="note-view-link">
          delete
        </div>
      </div>
      ...
      <Modal
        isOpen={deleting}
        toggle={props.cancelDeleteMethod}
        className="my-modal"
      >
        <ModalBody className="delete-modal">
          ...
          <div className="delete-buttons">
            ...
            <LambdaButton
              color="green"
              text="No"
              myFunc={props.cancelDeleteMethod}
            />
          </div>
        </ModalBody>
      </Modal>
