  ...
  if (props.appState !== "list")
    buttonArray.push(
      <LambdaButton
        ...
        color="green"
        myFunc={props.listMethod}
      />
    );

  //If we aren't in the create form, give the user a way to get there.
  if (props.appState !== "create")
    buttonArray.push(
      <LambdaButton
        key="2"
        text="+ Create New Note"
        color="green"
        myFunc={props.createMethod}
      />
    );
  ...
  if (props.appState === "list") {
    buttonArray.push(
      <LambdaButton
        ...
        text="Alphabetize"
        color="green"
        myFunc={props.alphabetizeNotes}
      />
    );
    buttonArray.push(
      <LambdaButton
        key="4"
        text="Reverse Alphabetize"
        color="green"
        myFunc={props.revAlphabetizeNotes}
      />
    );
    buttonArray.push(
      <LambdaButton
        key="5"
        text="Sort By Shortest"
        color="green"
        myFunc={props.shortestNotes}
      />
    );
    buttonArray.push(
      <LambdaButton
        key="6"
        text="Sort By Longest"
        color="green"
        myFunc={props.longestNotes}
      />
    );
  }
